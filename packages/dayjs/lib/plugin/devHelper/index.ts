...
export default (
  ...
  c: { prototype: any },
  d: {
    p: { customParseFormat: any };
    locale: (preset: any, object: any, isLocal: any) => any;
    Ls: { [x: string]: any };
  },
) => {
  ...
  if (!process || process.env.NODE_ENV !== 'production') {
    ...
    proto.parse = function (cfg: { args?: any; date?: any }) {
      const { date } = cfg;
    ...
    d.locale = function (preset: string | number, object: any, isLocal: any) {
