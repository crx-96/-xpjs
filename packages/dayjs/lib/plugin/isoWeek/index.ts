...
export default (o: any, c: { prototype: any }, d: { utc: any }) => {
  const getYearFirstThursday = (year: any, isUtc: any) => {
  ...
  const getCurrentWeekThursday = (ins: { add: (arg0: number, arg1: string) => any; isoWeekday: () => number }) =>
    ins.add(4 - ins.isoWeekday(), D);
  ...
  proto.isoWeek = function (week: number) {
  ...
  proto.isoWeekday = function (week: number) {
    if (!this.$utils().u(week)) {
